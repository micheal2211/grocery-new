...
if (isset($_GET['delete'])) {
    ...
    $delete_message = $conn->prepare("DELETE FROM `massage` WHERE id = ?");
...
<body>
   ...
   <form action="{{ route('message.delete', $fetch_message->idNo) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this message?');">
    @csrf
    @method('DELETE')
